...
const FooterCompanyLogin = () => {
    return (
        <>
            <footer id="sticky-footer" className="flex-shrink-0 w-100 text-center text-white fs-5 py-2" style={{ backgroundColor: '#93131D', position: 'absolute', bottom: 0 }}>
...
export default FooterCompanyLogin